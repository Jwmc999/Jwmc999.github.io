...
![Chronicle](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/ddffae51-b6f9-45c5-8066-3dc3bdbc9f32/Untitled.png)
...
- tokenization: seperation
- encoding: discrete type to integer
- embedding: discrete type to real-value (dense vector space)
- **Distributional representation (Count-based representation, Distribuitional semantics)**: the meaning of a word depends on the words that surround it (its context), and words which have similar contexts must be related to each other. *Not learned* from the data but heuristically constructed.
...
![LagugaeModel](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/9ddb2899-f178-4e2a-9bda-ebbec6ae8780/Untitled.png)
